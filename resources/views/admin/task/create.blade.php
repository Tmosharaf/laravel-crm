...
@section('content')
    ...
    <main class="w-full flex-grow p-6 bg-gray-50">
        <h1 class="text-3xl text-black pb-2">Create Task</h1>
        ...
        @role('admin')
            <form action="{{ route('tasks.store') }}" enctype="multipart/form-data" method="post" class="w-full max-w-2xl mx-auto">
                @csrf
                <div class="mb-6 ">
                ...
                <div class="mb-6">
                    <label for="projects" class="block text-gray-700 text-sm font-bold mb-2">
                        projects
                    </label>
