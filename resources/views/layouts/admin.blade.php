...
<body class="bg-gray-50 font-family-karla flex">
    ...
    <aside class="relative bg-gray-400 h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            {{ Route::is('dashboard.*') ? 'active-nav-link' : '' }}
            ">
            ...
            class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item
                {{ Route::is('users.*') ? 'active-nav-link' : '' }}
            ">
            ...
            class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item
                {{ Route::is('clients.*') ? 'active-nav-link' : '' }}
            ">
                <i class="fas fa-sticky-note mr-3"></i>
                Clients
            </a>
            ...
            class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item
                {{ Route::is('projects.*') ? 'active-nav-link' : '' }}
            ">
                <i class="fas fa-sticky-note mr-3"></i>
                {{ __('Projects') }}
            </a>
            ...
            class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item
                {{ Route::is('tasks.*') ? 'active-nav-link' : '' }}
            ">
                <i class="fas fa-sticky-note mr-3"></i>
                {{ __('Tasks') }}
            </a>
    ...
    <section class="w-full flex flex-col h-screen overflow-y-hidden">
        <!-- Desktop Header -->
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute text-center w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
